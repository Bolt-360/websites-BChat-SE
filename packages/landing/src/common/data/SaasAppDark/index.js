...
export const testimonials = [
  {
    ...
    author: 'Erico Cesar',
    designation: 'CEO',
    quote: `Estou totalmente apaixonado pelo BChat SE. O suporte ao cliente é impecável e essa plataforma supera facilmente concorrentes como chatbots comuns.`,
  },
  {
    id: 2,
    logo: logo2,
    ...
    quote: `O BChat SE é uma ferramenta essencial que nos ajuda a ter conversas em tempo real com nossos associados e a responder perguntas que não apenas melhoram a satisfação, mas também o engajamento.`,
  },
  {
    id: 1,
    logo: logo1,
